...
{
#if defined(__WXGTK__) && !defined(__WXGTK3__) && CL_BUILD
...
wxColour DrawingUtils::GetThemeTextColour()
{
#if CL_BUILD
    return EditorConfigST::Get()->GetCurrentOutputviewFgColour();
#else
    return wxSystemSettings::GetColour(wxSYS_COLOUR_WINDOWTEXT);
#endif
}
